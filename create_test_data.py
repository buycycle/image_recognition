...
SELECT * FROM first_ranked_bikes
UNION ALL
SELECT * FROM second_ranked_bikes
LIMIT 140
"""

def load_test_file(query, test_file_path):
    """
    ...
    bad_images = [420484 ,420481, 420477,420254, 420243, 420169, 420166, 420130, 420097, 420063, 420037, 420015, 419963, 419956, 419951, 419950, 419944, 419943, 419936, 419935, 419929, 420426, 420253,420250, 420246, 420239, 419975, 419970, 419923, 419919, 419916, 419911, 419910, 419902, 419889, 419744, 419772, 419820, 419859, 419718, 419727, 419729, 419734, 419778, 419668, 419675, 419619, 419663, 419665, 396073, 413778, 416177, 418195, 412501, 417481, 417354, 415755, 405161, 416017, 393353, 329811]
